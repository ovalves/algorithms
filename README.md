...
* `B` [Lista Encadeada (Linked List)](src/data-structures/linked-list/README.md)
* `B` [Lista Duplamente Ligada (Doubly Linked List)](src/data-structures/doubly-linked-list/README.md)
* `B` [Fila (Queue)](src/data-structures/queue/README.md)
* `B` [Stack](src/data-structures/stack/README.md)
* `B` [Tabela de Hash (Hash Table)](src/data-structures/hash-table/README.md)
* `B` [Heap](src/data-structures/heap/README.md)
* `B` [Fila de Prioridade (Priority Queue)](src/data-structures/priority-queue/README.md)
* `A` [Árvore de prefixos (Trie)](src/data-structures/trie/README.md)
* `A` [Árvore (Tree)](src/data-structures/tree/README.md)
  * `A` [Árvore de Pesquisa Binária (Binary Search Tree)](src/data-structures/tree/binary-search-tree/README.md)
  * `A` [Árvore AVL (AVL Tree)](src/data-structures/tree/avl-tree/README.md)
  * `A` [Árvore Vermelha-Preta (Red-Black Tree)](src/data-structures/tree/red-black-tree/README.md)
  * `A` [Árvore de Segmento (Segment Tree)](src/data-structures/tree/segment-tree/README.md) - com exemplos de consultas min / max / sum range
  * `A` [Árvore Fenwick (Fenwick Tree)](src/data-structures/tree/fenwick-tree/README.md) (Árvore indexada binária)
* `A` [Gráfico (Graph)](src/data-structures/graph/README.md) (ambos dirigidos e não direcionados)
* `A` [Conjunto Disjuntor (Disjoint Set)](src/data-structures/disjoint-set/README.md)
* `A` [Filtro Bloom (Bloom Filter)](src/data-structures/bloom-filter/README.md)
